...
public class ThumbMaker {
    public static void MakeThumb(string srcPath, string destPath) {
...
[ThumbMaker]::MakeThumb('c:\xampp\htdocs\ba-in\assets\images\blog\1.jpg', 'c:\xampp\htdocs\ba-in\assets\images\blog\1-s.jpg')
