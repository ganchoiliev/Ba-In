...
public class ThumbMaker {
    public static void MakeHover(string srcPath, string destPath) {
        ...
        using (Graphics g = Graphics.FromImage(bmp)) {
            ...
            // Calculate scaled image size (object-fit: cover)
    ...
    public static void MakeThumbRounded(string srcPath, string destPath) {
        ...
        using (Graphics g = Graphics.FromImage(bmp)) {
            ...
            // Define inner image bounds and radius
            int pad = 20;
...
[ThumbMaker]::MakeThumbRounded('C:\Users\ZapEc\.gemini\antigravity\brain\b7223f44-bf89-418c-ab44-faa0b73da211\media__1772409708185.jpg', 'c:\xampp\htdocs\ba-in\assets\images\blog\1-s.jpg')
[ThumbMaker]::MakeHover('C:\Users\ZapEc\.gemini\antigravity\brain\b7223f44-bf89-418c-ab44-faa0b73da211\media__1772409708185.jpg', 'c:\xampp\htdocs\ba-in\assets\images\blog\1.jpg')
Write-Host "Perfect padded thumbnail generated with rounded corners!"
