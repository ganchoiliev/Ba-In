...
// Ако бот е попълнил скритото поле "website", просто спираме скрипта (заблуждаваме бота, че е успешно)
if (!empty($website)) {
    echo "<div class='inner success'><p class='success'>Благодарим ви за съобщението!</p></div>";
    exit;
}
...
if ($services) {
    $body .= "Процедура: $services\r\n";
}
if ($date) {
    $body .= "Предпочитана дата: $date\r\n";
}
if ($doctor) {
