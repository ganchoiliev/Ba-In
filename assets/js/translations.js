...
const TRANSLATIONS = {
    ...
    bg: {
        ...
        /* ---- Pricing / FAQ / Blog ---- */
        'pricing.section_title': 'Ценоразпис на услугите',
        'pricing.intro_text': 'Цената за всяка процедура се определя индивидуално според специфичните нужди на вашата кожа и желания ефект. Свържете се с нас за безплатна консултация, за да получите точна оферта.',
        'pricing.mb.features': '<li>✔ Индивидуален дизайн и измерване</li><li>✔ Висококачествени пигменти (PhiBrows)</li><li>✔ Естествен косъмчест ефект</li><li>✔ Цена: по запитване / след консултация</li>',
        'pricing.micro.features': '<li>✔ Подобряване на текстурата и порите</li><li>✔ Лечение на белези от акне</li><li>✔ Стимулиране на колаген</li><li>✔ Цена: по запитване / след консултация</li>',
        'pricing.lam.features': '<li>✔ Lash Lift (Ламиниране на мигли)</li><li>✔ Brow Lift (Ламиниране на вежди)</li><li>✔ Боядисване и подхранване</li><li>✔ Цена: по запитване / след консултация</li>',
        'pricing.book_consult': 'Запази консултация',
        'pricing.note': 'Забележка: Посочваме точна цена след кратка консултация (на място или по съобщение), за да е най-точна и коректна спрямо вашите нужди.',
    ...
    en: {
        ...
        /* ---- Pricing / FAQ / Blog ---- */
        'pricing.section_title': 'Service Pricing',
        'pricing.intro_text': "The price for each treatment is determined individually based on your skin's specific needs and desired effect. Contact us for a free consultation to get an accurate quote.",
        'pricing.mb.features': '<li>✔ Individual design and measurement</li><li>✔ High-quality PhiBrows pigments</li><li>✔ Natural hair-stroke effect</li><li>✔ Price: on request / after consultation</li>',
        'pricing.micro.features': '<li>✔ Improved skin texture and pores</li><li>✔ Acne scar treatment</li><li>✔ Collagen stimulation</li><li>✔ Price: on request / after consultation</li>',
        'pricing.lam.features': '<li>✔ Lash Lift (Lash Lamination)</li><li>✔ Brow Lift (Brow Lamination)</li><li>✔ Tinting and nourishing</li><li>✔ Price: on request / after consultation</li>',
        'pricing.book_consult': 'Book a Consultation',
        'pricing.note': 'Note: We provide an exact price after a brief consultation (in person or by message) to ensure it is as accurate and fair as possible for your needs.',
