...
const TRANSLATIONS = {
   ...
   bg: {
      ...
      /* ---- Pricing / FAQ / Blog ---- */
      'pricing.section_title': 'Частна консултация',
      'pricing.intro_text': 'В момента не публикуваме фиксирани цени — всяка процедура се оценява индивидуално, спрямо твоите нужди, кожа и желан резултат. Запази частна консултация и ще получиш персонализирана препоръка и точна цена.',
      'pricing.consult_why_title': 'Какво включва консултацията?',
      'pricing.consult_f1': 'Оценка на кожата и индивидуалните ти нужди',
      'pricing.consult_f2': 'Персонализирана препоръка за процедура',
      'pricing.consult_f3': 'Точна и прозрачна цена без изненади',
      'pricing.consult_f4': 'Отговор на всички твои въпроси',
      'pricing.book_consult': 'Запази консултация',
      'pricing.note': 'Консултацията може да се проведе на място или по съобщение — изберете каквото ви е удобно.',
   ...
   en: {
      ...
      /* ---- Pricing / FAQ / Blog ---- */
      'pricing.section_title': 'Private Consultation',
      'pricing.intro_text': "We currently don't publish fixed prices — every treatment is assessed individually based on your needs, skin type and desired result. Book a private consultation and you'll receive a personalised recommendation and an accurate quote.",
      'pricing.consult_why_title': 'What does the consultation include?',
      'pricing.consult_f1': 'Assessment of your skin and individual needs',
      'pricing.consult_f2': 'Personalised treatment recommendation',
      'pricing.consult_f3': 'Accurate and transparent pricing with no surprises',
      'pricing.consult_f4': 'Answers to all your questions',
      'pricing.book_consult': 'Book a Consultation',
      'pricing.note': 'The consultation can take place in person or by message — choose whatever suits you best.',
